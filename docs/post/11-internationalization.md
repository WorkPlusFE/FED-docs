...
实现方式：react国际化自动化插件 [react-i18n-auto](https://github.com/mr18/react-i18n-auto)
...
1.安装vue-swift-i18n(vscode插件)
  ...
  商店搜索vue-swift-i18n，或者ctrl+p,输入ext install RichieChoo.
  vue-swift-i18n
...
1.检测vue/js中的需要国际化的字，自动生成json文件。
...
#### 一、Json生成，更新(Ctrl+Alt+U/Ctrl+Command+U)
<p>
